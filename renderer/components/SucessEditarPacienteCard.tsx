...
export default function SucessRegisterPacienteCard({ setOffSuccessEditarRegisterScreen}) {

    const setOffScreen = () =>{
        setOffSuccessEditarRegisterScreen(false)
    }
            ...
            <section className="fixed flex flex-col mt-[-2.5rem] w-full self-center justify-center h-screen bg-slate-800/80 px-64 pt-16 z-10">
                <div className="bg-white w-full lg:w-[50rem] lg:mx-auto h-auto flex flex-col rounded-lg">
                    <div className="flex my-3 w-full h-14 justify-between px-16 items-center mt-5">
                        <h1 className="flex text-3xl mx-auto font-bold">Cadastro de paciente feito com sucesso!</h1>
