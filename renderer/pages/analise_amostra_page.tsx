...
import SucessCadastrarAmostraCard from "../components/analise_amostra_page/SucessCadastrarAmostraCard"

export default function AnaliseAmostraPage() {
    const [successCadastrarAmostra, setSuccessCadastrarAmostra] = useState(false);
        const setOffSucessCadastrarAmostraCard = () => {
            setSuccessCadastrarAmostra(false)
        }
        const setOnSucessCadastrarAmostraCard = (e) => {
            e.preventDefault()
    ...
    return (
        <>
            <TitleBar/>
            {successCadastrarAmostra ? <SucessCadastrarAmostraCard setOffSucessCadastrarAmostraCard={setOffSucessCadastrarAmostraCard} /> : <></>}
                    ...
                    <div className="p-2.5">
                        <form>
                            ...
                            <div className="flex flex-col mt-4 text-white font-bold gap-4">
                                ...
                                <button onClick={(e)=>setOnSucessCadastrarAmostraCard(e)} className="block w-full text-white bg-indigo-600 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-3 text-center h-12">Cadastrar Análise</button>
                            </div>
                        </form>
                    </div>
                </div>
